...
function Get-AlertPolicyEnablePayload ($Name, $AlertPolicyIds) {
    $Payload = '{
...
function Enable-OMEAlertPolicy {
    <#
...
#>
    ...
    Process {
        ...
        Try {
            ...
            $JobUrl = $BaseUri + "/api/AlertService/Actions/AlertService.EnableAlertPolicies"
            ...
            if ($AlertPolicyIds.Count -gt 0) {
                $AlertPolicyEnablePayload = Get-AlertPolicyEnablePayload -AlertPolicyIds $AlertPolicyIds
